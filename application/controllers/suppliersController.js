app.controller('suppliersController', ['$scope', 'suppliersFactory', 'DateService', 'stockModel', 'NotificationService', function($scope, suppliersFactory, DateService, stockModel, NotificationService) {
    ...
    $scope.isActive = ID => {
        let index = $scope.supplierDebts.findIndex(index => index.supplier_ID == ID);
    ...
    $scope.submitPayment = () => {
        suppliersFactory.submitPayment($scope.paymentData).then(function (response) {
            if (response) {
    ...
    // submit edit payment
    $scope.editPayment = () => {
        suppliersFactory.editPayment($scope.paymentData).then(function (response) {
            if (response) {
