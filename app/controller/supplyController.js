app.controller("supplyController", [
  "$scope",
  "supplyFactory",
  "DateService",
  "supplyFactory",
  ...
  function (
    ...
    $scope.submitItem = () => {
      let index = $scope.items.findIndex(
        x => x.item_name == $scope.selectedItem
      );
    ...
    $scope.getSupplierID = () => {
      let index = $scope.suppliers.findIndex(
        x => x.supplier_name == $scope.selectedSupplier
      );
